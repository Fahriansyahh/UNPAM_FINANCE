...
import { ButtonDatePicker, DeleteUser, FilterSearchTable } from "../Components";
        ...
        <ul className="d-inline-block m-0 p-0" style={{ listStyle: "none" }}>
          <li className="d-inline-block m-0 p-0">
            <i
              ...
              style={{ color: "green" }}
              onClick={() => {
                sessionStorage.setItem("Income", JSON.stringify(row.id));
                history.push("/finance/ItemIncome");
              }}
            ></i>
          </li>
          <li className="d-inline-block m-0 p-0 mx-2">
            <i
              ...
              onClick={() => {
                sessionStorage.setItem("Income", JSON.stringify(row.id));
                history.push("/finance/EditIncome");
              }}
            ></i>
          </li>
          <li
          ...
          <div className="page-header mb-0 pb-0">
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb" style={{ marginRight: "-16px" }}>
                ...
                <li className="breadcrumb-item">Pendapatan</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div className="row ">
        ...
        >
          <button
            ...
            onClick={() => {
              history.push("/finance/CreateIncome");
            }}
          >
