...
import { UpdateExpense, GetItemExpense } from "../Action/Api/Expense";
...
const EditExpense = () => {
  ...
  useEffect(() => {
    ...
    GetItemExpense(setOldData);
  }, [setDataCashflow, Cashflow, setOldData]);
  useEffect(() => {
  ...
  const handleSave = () => {
    if (OldData) {
      ...
      data.append(
        ...
        childCashflow || OldData.cashflow_category.id
      );
      ...
      UpdateExpense(data, history, setError);
    }
  };
                        ...
                        <Form.Group className="row my-0 py-0">
                          ...
                          <div className="col-sm-9">
                            <Select
                              ...
                              placeholder={
                                OldData.cashflow_category.cashflow_category_name
                              }
