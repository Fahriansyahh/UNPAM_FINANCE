...
import { CreateIncomeApi } from "../Action/Api/Income";
import {
  handleAmountChange,
  formatToRupiah,
...
const CreateIncome = () => {
  ...
  const handleSave = () => {
    ...
    data.append("cashflow_category_id", Cashflow);
    ...
    CreateIncomeApi(data, history, setError);
  };
                    ...
                    <div className="col-sm-12">
                      <Form.Group className="row mt-0 pt-0">
                        <label htmlFor="exampleTextarea1 col-sm-12 col-form-label ">
                          <span style={{ marginLeft: "20px" }}>Deskripsi</span>
                        </label>
                        <textarea
