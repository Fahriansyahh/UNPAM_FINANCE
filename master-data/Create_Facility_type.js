...
import { GetAllParent, CreateApi } from "../Action/Api/Facility_type";
import { useEffect } from "react";

const Create_Facility_type = () => {
  ...
  //!get all parent and get all child
  useEffect(() => {
    GetAllParent(setOptionsName);
  }, []);
  //! exit
  ...
  const handleSave = () => {
    ...
    CreateApi(data, setError, history);
  };
...
export default Create_Facility_type;
