...
import { CreateCashflow, getParent } from "../Action/Api/Cashflow";
const Create_Cashflow_Categories = () => {
  ...
  const handleSave = async () => {
    const data = {
      ...
      parent_id: Parent,
      cashflow_category_name: NameCategories,
      percentage: percetage,
    };
    CreateCashflow(data, setError, history);
  };
  ...
  }, [setOptionsParent, typeCategories]);
...
export default Create_Cashflow_Categories;
